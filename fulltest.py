...
nearPlane = 400 # distance at nearest point before errors
farPlane = 850 # distance at background
...
#	lastF = newF
	...
	distScale = fdist/(farPlane-nearPlane)
	for f in feathers:
		f.setServoFromTime(180-distScale*180)
